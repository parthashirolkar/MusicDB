...
class Encoder(nn.Module):
    def __init__(self, input_dim, hidden_dim_1, hidden_dim_2):
        ...
        self.lstm1 = nn.LSTM(
            input_dim, hidden_dim_1, bidirectional=True, batch_first=True
        )
        self.lstm2 = nn.LSTM(
            hidden_dim_1 * 2, hidden_dim_2, bidirectional=True, batch_first=True
        )
...
class Decoder(nn.Module):
    def __init__(self, hidden_dim_2, hidden_dim_1):
        ...
        self.lstm1 = nn.LSTM(
            hidden_dim_2 * 2, hidden_dim_2, bidirectional=True, batch_first=True
        )
        self.lstm2 = nn.LSTM(
            hidden_dim_2 * 2, hidden_dim_1, bidirectional=True, batch_first=True
        )
